...
* Accpetance of the conservancies has improved with over 90% of those interviewed accepting that conservancies have improved their well-being
...
```{r echo=FALSE, fig.cap= "At the time that THIS conservancy was set up, did the land title holder personally agree with that decision? Does the land title holder agree with the community's decision to have THIS conservancy at the moment?", out.width= "60%"}
