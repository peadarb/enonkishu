...
# Governance
```{r echo=FALSE}
knitr::include_graphics("images/authority over conservancy.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("images/women have power to influence decisions in this conservancy.png")
```
